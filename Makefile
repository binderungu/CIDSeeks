.PHONY: sync smoke smoke-suite paper-core paper-core-full paper-core-flagship paper-core-gate-subset robustness auth-sensitivity scalability acceptance acceptance-pr acceptance-nightly lint typecheck-staged test reproduce legacy-import-guard shell-safety-guard tar-safety-guard deterministic-rng-guard manifest-integrity-guard public-hygiene-guard compliance stats-gate-smoke stats-gate-paper-core bundle-smoke verify-bundle-smoke public-snapshot ci-core-local ci-paper-core-gate-local publish-freeze-local
...
compliance: legacy-import-guard shell-safety-guard tar-safety-guard deterministic-rng-guard manifest-integrity-guard public-hygiene-guard
...
ci-core-local: sync lint typecheck-staged legacy-import-guard test smoke-suite manifest-integrity-guard stats-gate-smoke bundle-smoke verify-bundle-smoke

ci-paper-core-gate-local: sync lint typecheck-staged legacy-import-guard paper-core-gate-subset manifest-integrity-guard stats-gate-paper-core
